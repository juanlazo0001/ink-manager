...
export const en = {
  ...
  estimate: {
    invalidBodyByKind: {
      ...
      expired: 'Please contact the studio to request a new estimate.',
    ...
    budgetBody: "We've passed your budget along to the studio — they'll follow up with you directly.",
    declineHeading: "We're sorry to see you go",
    declineBody: 'Thanks for considering us — if anything changes, we\'d love to hear from you.',
  ...
  intake: {
    ...
    smsOptInBody:
      'I agree to receive text messages from {{studioName}} regarding my appointment, including reminders and updates. Message and data rates may apply. Reply STOP to opt out. View our {{privacyPolicyLink}} and {{termsLink}}.',
