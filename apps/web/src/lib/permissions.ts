...
//
// Reorganized (from a single flat list) into the 11 grouped sections the
// Settings -> Permissions tab now renders as collapsible groups, each with
// a plain-language label + one-line description per key (never a raw key
// name like "inquiries.markLost") -- same friendly-dictionary spirit as
// Settings.tsx's own JOB_DISPLAY for the System panel.
